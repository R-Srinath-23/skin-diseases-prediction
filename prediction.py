...
PREDICTION_MODEL="C:\ML Project\skin_prediction\skin_disease_mobilenetv2_weights.pth"
...
def predict_image(image_path):
    ...
    if confidence.item() < 0.75:
        return "Prediction not confident enough"
    else:
        return DATA_SET_CLASSES[predicted_class.item()]

        # _, predicted = torch.max(output, 1)
    # return DATA_SET_CLASSES[predicted.item()]
